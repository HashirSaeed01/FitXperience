...
class FoodDisplayWidget extends ConsumerWidget {
  final Food food;

  const FoodDisplayWidget({super.key, required this.food});
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                        '${food.servings} servings, Ready in ${food.readyInMinutes} minutes',
                        style: GoogleFonts.montserrat(
                            textStyle: TextStyle(
                                color: Colors.black,
                                fontSize: 16,
                  ...
                  Column(
                    children: [
                      Padding(
                        ...
                        child: Text(food.summary.toString(),
                            style: GoogleFonts.montserrat(
                                textStyle: TextStyle(
                                    color: Colors.black,
                                    fontSize: 16,
